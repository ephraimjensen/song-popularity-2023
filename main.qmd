...
__There is no significat difference between the performance of songs that have a single artist and a song made my multiple artists.__
...
fig.update_traces(marker=dict(opacity=1, line=dict(width=0)))#size=35,symbol="square",
