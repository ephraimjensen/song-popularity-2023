...
count = 0
for item in avg_stream_count["streams"]:
    if item == -1:
        print(f"problem found! index : {count}, value: {item}")
        # print(avg_stream_count[count])
    count += 1
...
in_charts = f_musicdf.loc[f_musicdf["in_spotify_charts"] != 0]
